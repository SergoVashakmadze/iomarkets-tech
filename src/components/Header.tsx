...
const ecosystemDomains = [
  {
    ...
    url: 'https://iomarkets.org',
    icon: '\u{1F3DB}\uFE0F',
  },
  {
    name: 'IoMarkets.io',
    subtitle: 'AI-Powered Web3 Capital Markets',
    url: 'https://iomarkets.io',
    icon: '\u{1F4C8}',
  },
  {
    name: 'IoMarkets.money',
    subtitle: 'Digital Money, Stablecoins & Payments',
    url: 'https://iomarkets.money',
    icon: '\u{1F4B0}',
  },
  {
    name: 'IoMarkets.xyz',
    subtitle: 'Digital Collectibles & NFT Platform',
    url: 'https://iomarkets.xyz',
    icon: '\u{1F3A8}',
  },
  {
    name: 'IoMarkets.com',
    subtitle: 'Advanced Cryptocurrency Trading Exchange',
    url: 'https://iomarkets.com',
    icon: '\u{1F4B9}',
  },
  {
    name: 'IoMarkets.ai',
    subtitle: 'AI-Powered Markets Intelligence',
    url: 'https://iomarkets.ai',
    icon: '\u{1F916}',
  },
  {
    name: 'IoMarkets.co',
    subtitle: 'Corporate Finance & Investor Relations',
    url: 'https://iomarkets.co',
    icon: '\u{1F3E2}',
  },
  {
    name: 'IoMarkets.vc',
    subtitle: 'Venture Capital Investment Fund',
    url: 'https://iomarkets.vc',
    icon: '\u{1F680}',
  },
  {
    name: 'IoMarkets.fund',
    subtitle: 'Asset Management',
    url: 'https://iomarkets.fund',
    icon: '\u{1F4CA}',
  },
  {
    name: 'IoMarkets.tv',
    subtitle: 'Global Financial News Television',
    url: 'https://iomarkets.tv',
    icon: '\u{1F4FA}',
  },
  {
    name: 'IoMarkets.news',
    subtitle: 'Global Online Financial News',
    url: 'https://iomarkets.news',
    icon: '\u{1F4F0}',
  },
  {
    name: 'IoMarkets.tech',
    subtitle: 'Financial Technology Solutions',
    url: 'https://iomarkets.tech',
    icon: '\u2699\uFE0F',
    current: true,
  },
];
          ...
          <nav className="flex items-center justify-between h-16">
            ...
            <Link to="/" className="flex items-center gap-3 group">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[9px] text-slate-500 -mt-0.5 uppercase tracking-wider font-bold">TECHNOLOGY</span>
              </div>
            </Link>
            ...
            <div className="hidden lg:flex items-center gap-4">
              ...
              <div ref={ecosystemRef} className="relative">
                ...
                >
                  IoMarkets Ecosystem
                  <ChevronDown
                    className={`w-4 h-4 transition-transform ${ecosystemOpen ? 'rotate-180' : ''}`}
                  />
                </button>
                      ...
                      {ecosystemDomains.map((domain) => (
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            <p className={`text-sm font-medium truncate ${domain.current ? 'text-white' : 'text-gray-200'}`}>
                              {domain.name}
                            </p>
                            <p className={`text-xs truncate ${domain.current ? 'text-amber-500' : 'text-gray-400'}`}>
                              {domain.subtitle}
                            </p>
                          </div>
                        </a>
                    ...
                    <div className="p-2">
                      {ecosystemDomains.map((domain) => (
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            <p className={`text-xs font-medium truncate ${domain.current ? 'text-white' : 'text-gray-200'}`}>
                              {domain.name}
                            </p>
                            <p className={`text-[10px] truncate ${domain.current ? 'text-amber-500' : 'text-gray-400'}`}>
                              {domain.subtitle}
                            </p>
                          </div>
                        </a>
